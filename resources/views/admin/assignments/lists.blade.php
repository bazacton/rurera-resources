    ...
    <section class="card">
        ...
        <div class="defined-searches mt-20" style="display:none">
            ...
            @if( !empty( $saved_templates ) )
                ...
                @endforeach
            @endif
            <button type="button" class="btn btn-success save-template test" data-form_id="topic_parts_search_form" data-template_type="assignments_search" ><i class="fas fa-save"></i> Save Template</button>
        </div>
    </section>
    <div class="row">
