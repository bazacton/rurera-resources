                                                ...
                                                <div class="years-group populated-data">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 col-6 attempts-fields rurera-hide">
                                                            <div class="form-group assignment_method_check_fields practice_fields">
                                                    ...
                                                    <div class="rurera-notes conditional_fields Individual_field"><i class="fas fa-info-circle"></i> You must manually select specific students. Only those selected will have access to the assignment. Class changes will not affect this.</div>
                                                            ...
                                                            <select name="ajax[{{ !empty($assignment) ? $assignment->id : 'new' }}][assignment_school]" class="form-control select2 school_condition">
                                                                ...
                                                                @if( $schools_list->count() > 0 )
                                                                    ...
                                                                    @foreach( $schools_list as $schoolObj)
                                                                        @php $selected = ($school_counter == 1)? 'selected' : '' @endphp
                                                                        <option value="{{$schoolObj->id}}" {{$selected}}>
                                                                            {{$schoolObj->title}}
                                                                        </option>
                                                                        @php $school_counter++; @endphp
                                                                    @endforeach
                                                                @endif
                                                            </select>
                                                            <div class="invalid-feedback"></div>
