            ...
            <div class="card-body">
				...
				<span><strong>Defined Searches:</strong></span>
					@if( !empty( $saved_templates ) )
						...
						@endforeach
					@endif
					<button type="button" class="btn btn-success save-template test@" data-form_id="gallery_images_search_form" data-template_type="gallery_images_search" ><i class="fas fa-save"></i> Save Template</button>
				</div>
        </section>
