        ...
        <div class="section-body">
            <div class="row">
                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="topic-parts-form" action="/admin/questions-generator/prompt_generator_single_submit"
                                  method="Post">
                                {{ csrf_field() }}
								...
								<div class="col-6 col-md-6 col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select data-return_type="option"
                                                ...
                                                class="ajax-chapter-dropdown form-control select2 @error('chapter_id') is-invalid @enderror"
                                                id="chapter_id" name="chapter_id">
                                            <option disabled selected>Chapters</option>
                                        </select>
                                        @error('chapter_id')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select data-return_type="option"
                                                ...
                                                class="ajax-subchapter-dropdown form-control select2 @error('sub_chapter_id') is-invalid @enderror"
                                                id="sub_chapter_id" name="sub_chapter_id">
                                            <option disabled selected>Chapters</option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select data-return_type="option"
                                                ...
                                                class="topic-parts-data form-control select2 @error('topic_part_item_id') is-invalid @enderror"
                                                id="topic_part_item_id" name="topic_part_item_id">
                                            <option disabled selected>Topic Part Item</option>
                                        </select>
