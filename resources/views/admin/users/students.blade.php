        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle"><img src="/assets/default/svgs/user-alt-2-svgrepo-com.svg" alt="user-account"> Invite New Members to {{isset($userObj->userSchool->id)? $userObj->userSchool->title : ''}}</h5>
...
<script>
    function refresh_students(){
        $.ajax({
            type: "GET",
            url: '/admin/users/get_students_list',
            success: function (return_data) {
                $(".students-tab-students").html(return_data);
            }
        });
    }
