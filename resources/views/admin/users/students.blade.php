...
@section('content')
    ...
    <div class="section-body skeleton">
        ...
        @if($schools_list->count() > 1)
            <section class="card">
                <div class="card-body">
                    <form action="/admin/students" id="classes_search_form" method="get" class="row mb-0">
                        <div class="col-md-4">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle"><img src="/assets/default/svgs/user-alt-2-svgrepo-com.svg" alt="user-account"> Invite New Members to {{$userObj->userSchool->title}}</h5>
