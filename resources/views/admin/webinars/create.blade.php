                            ...
                            <form method="post" action="{{ getAdminPanelUrl() }}/webinars/{{ !empty($webinar) ? $webinar->id.'/update' : 'store' }}" id="webinarForm" class="webinar-form">
                                ...
                                <div class="rurera-webinar-tabs">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="mock-test" role="tabpanel" aria-labelledby="mock-test-tab">
                                            <section>
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-md-12">
                                                            ...
                                                            <div class="col-12 col-md-4 col-lg-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="webinar_type" class="conditional_field_parent custom-select @error('type')  is-invalid @enderror">
                                                                        ...
                                                                        <option data-target_common_class="webinar_type_fields" data-target_field_class="test_total_time_field" value="Mock Exams" @if( !empty($webinar) and $webinar->webinar_type == 'Mock Exams') selected @endif>Practice Mock Exams</option>
                                                                        <option data-target_common_class="webinar_type_fields" data-target_field_class="test_total_time_field" value="Both" @if( !empty($webinar) and $webinar->webinar_type == 'Both') selected @endif>Both</option>
                                                                    </select>
                                                                    @error('type')
                                                                    <div class="invalid-feedback">
                                                                        {{ $message }}
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <h2 class="section-title after-line">SEO Settings</h2>
                                                            </div>
                                                            <div class="col-12 col-md-4 col-lg-4">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-12 col-md-4 col-lg-4">
                                                                <div class="form-group custom-switches-stacked">
                                                                    ...
                                                                    <label class="custom-switch pl-0">
                                                                        <label class="custom-switch-description mb-0 mr-2 ml-0">{{ trans('admin/main.no_follow') }}</label>
                                                            ...
                                                            <div class="col-12 col-md-4 col-lg-4 rurera-hide">
                                                                <div class="form-group custom-switches-stacked">
                                                                    ...
                                                                    <label class="custom-switch pl-0">
                                                                        <label class="custom-switch-description mb-0 mr-2 ml-0">Not Include</label>
...
@push('scripts_bottom')
    <script>
        ...
        $("body").on("change", ".webinar_practice_type", function (e) {
            ...
            $(".webinar_practice_type_field").val(webinar_practice_type);
        });

        $('.webinar_practice_type').change();
