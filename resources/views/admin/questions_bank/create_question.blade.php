...
<style>
    ...
    .equationModal .toolbar{
        ...
        padding:0 0 25px;border-bottom:1px solid var(--line);position:relative
    }
    .equationModal .tool{
    ...
    .equationModal .btn-primary{background:var(--primary);color:#fff;border-color:var(--primary);}
