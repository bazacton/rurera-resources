                                                    ...
                                                    <div class="tab-pane fade py-0" id="topic-parts" role="tabpanel" aria-labelledby="topic-parts-tab">
                                                        <div class="lms-element-properties">
                                                            ...
                                                            <div class="topic-parts-options">
                                                                ...
                                                                <label for="topics_parts-875"><h5 class="font-16 font-weight-bold text-dark">How Cells Get What They Need</h5> Cells require a steady supply of oxygen and glucose to perform respiration, producing energy necessary for survival. Aerobic respiration takes place in the mitochondria, where oxygen and glucose react to produce carbon dioxide and water as waste. Blood transports oxygen and glucose to cells while removing carbon dioxide and water. The heart’s constant pumping keeps blood circulating through blood vessels, delivering essentials to cells and carrying away waste, ensuring efficient cellular function and supporting the body’s overall energy needs.</label>
                                                                </div>
                                                                <div class="form-field rureraform-cr-container-medium">
                                                                    <input class="rureraform-checkbox-medium" type="checkbox" name="topic_part_item_id" id="topics_parts-876" value="876">
                                                                    <label for="topics_parts-876"><h5 class="font-16 font-weight-bold text-dark">Understanding Blood Composition</h5> Blood may appear as a simple red liquid, but under a microscope, it reveals a complex structure. Plasma, the liquid component of blood, is mostly water and carries red and white blood cells throughout the body. Plasma also transports dissolved substances, such as glucose, from the digestive system to cells. Carbon dioxide, a byproduct of respiration, dissolves in plasma and is carried to the lungs, where it is exhaled. This essential transport system ensures that each cell receives what it needs and that waste is safely removed from the body.</label>
                                                                </div>
                                                                <div class="form-field rureraform-cr-container-medium"> 
                                                                    <input class="rureraform-checkbox-medium" type="checkbox" name="topic_part_item_id" id="topics_parts-877" value="877">
                                                                    <label for="topics_parts-877"><h5 class="font-16 font-weight-bold text-dark">Red Blood Cells and Their Role</h5> Red blood cells are specialized for oxygen transport. Lacking nuclei and mitochondria, these cells maximize space for haemoglobin, the red pigment that binds oxygen. In the lungs, oxygen diffuses into the blood and binds with haemoglobin to form oxyhaemoglobin, giving blood its bright red color. As blood circulates, oxyhaemoglobin releases oxygen to cells for respiration. Red blood cells then return to the lungs to collect more oxygen. Their small, flexible shape helps them squeeze through capillaries, allowing them to deliver oxygen close to alveoli and respiring cells.</label>
                                                                </div>
                                                                <div class="form-field rureraform-cr-container-medium">
                                                                    <input class="rureraform-checkbox-medium" type="checkbox" name="topic_part_item_id" id="topics_parts-878" value="878">
                                                                    <label for="topics_parts-878"><h5 class="font-16 font-weight-bold text-dark">Why Red Blood Cells Lack Organelles</h5> Red blood cells are unique because they lack nuclei and mitochondria, which helps them carry more haemoglobin, thus transporting more oxygen. Scientists believe that without mitochondria, red blood cells avoid using the oxygen they carry, dedicating it solely to other cells. Their flexible shape also allows them to move through tiny capillaries. This adaptation is essential for maximizing oxygen delivery to cells, showing how specialized structures can enhance a cell’s function within the body’s complex system.</label>
                                                                </div>
                                                                <div class="form-field rureraform-cr-container-medium">
                                                                    <input class="rureraform-checkbox-medium" type="checkbox" name="topic_part_item_id" id="topics_parts-879" value="879">
                                                                    <label for="topics_parts-879"><h5 class="font-16 font-weight-bold text-dark">White Blood Cells and Immune Defense</h5> White blood cells, distinguishable by their nuclei, play a vital role in defending the body against pathogens such as bacteria and viruses. Some white blood cells can change shape to capture and digest bacteria through a process called phagocytosis. Other white blood cells produce antibodies—Y-shaped molecules that target pathogens. Antibodies can kill pathogens directly or clump them together, making it easier for other white blood cells to destroy them. This defense system helps the body resist infections, keeping the body healthy and resilient.</label>
                                                                </div>
                                                                <div class="form-field rureraform-cr-container-medium"> 
                                                                    <input class="rureraform-checkbox-medium" type="checkbox" name="topic_part_item_id" id="topics_parts-880" value="880">
                                                                    <label for="topics_parts-880"><h5 class="font-16 font-weight-bold text-dark">The Role of Antibodies in Immunity</h5> Antibodies, produced by certain white blood cells, are essential to the immune response. Each antibody targets a specific pathogen, binding to it and either killing it or clumping it with others, stopping its spread. This precision allows the body to recognize and respond to various threats efficiently. When antibodies stick to pathogens, they mark them for destruction, aiding white blood cells in identifying and eliminating these invaders. This sophisticated process is crucial in maintaining health, as it helps the immune system fend off numerous potential infections.</label>
                                                                </div>
                                                            </div>
                                                            </div>
