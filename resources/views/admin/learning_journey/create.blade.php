...
@push('scripts_bottom')
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.show_hide_start_layers', function () {
            ...
            $(this).closest('.editor-zone').find('.path-initializer[data-item_type="'+item_type+'"]').attr('data-visibility', 'yes');
            if(current_value == false){
                ...
                $(this).closest('.editor-zone').find('.path-initializer[data-item_type="'+item_type+'"]').attr('data-visibility', 'no');
