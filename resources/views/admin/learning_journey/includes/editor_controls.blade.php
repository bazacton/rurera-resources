	...
	<div class="editor-objects-block tab-pane fade" id="layers{{$data_id}}" role="tabpanel" aria-labelledby="profile-tab">
        ...
        <div class="tab-pane mt-3 fade" id="levels_layers{{$data_id}}" role="tabpanel" aria-labelledby="levels_layers-tab{{$data_id}}">
            ...
            <ul class="editor-objects-list levels-objects-list {{$data_id}}">
                @php
                    if( isset( $itemObj->id ) && !empty( $itemObj->LearningJourneyObjects->whereIn('item_type', array('topic', 'treasure'))->where('status','active') )){
                        foreach( $itemObj->LearningJourneyObjects->whereIn('item_type', array('topic', 'treasure'))->where('status','active') as $learningJourneyItemObj){
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu">
                                <i class="fa fa-plus add-spacer"></i><i class="fa fa-trash"></i><i class="lock-layer fa fa-unlock"></i><i class="fa fa-sort"></i>
                            </div>
                            </div>
                            </li>
                            ';
