        ...
        <ul class="sidebar-menu">
                        ...
                        <div class="sub-menu-sidebar dropdown-menu" aria-labelledby="sub-menu">
                            <div class="dropdown-content">
                                ...
                                <ul class="sub-menu" id="accordion">
                                    <li>
                                        <a href="#" data-toggle="collapse" href="#learning" data-target="#learning" aria-expanded="true" aria-controls="learning">Learning Content</a>
			...
			@can('admin_question_ai')
                ...
                <li class="nav-item{{ (request()->is('admin/questions-generator')) ? 'active' : '' }}">
                    <a href="{{ getAdminPanelUrl('/questions-generator/') }}" class="nav-link">
                        <i class="fas fa-question"></i>
                        <span>Question AI +</span>
                    </a>
                </li>
            @endcan()
           ...
           @endcan()
            ...
            @can('admin_teachers_list')
                <li class="nav-item {{ (request()->is('admin/teachers')) ? 'active' : '' }}">
                    <a href="{{ getAdminPanelUrl('/teachers') }}" class="nav-link">
                        <img src="/assets/default/img/sidebar/learn.svg" alt="learn">
                        <span>Teachers</span>
                    </a>
                </li>
            @endif
            ...
            @if($authUser->can('admin_supports') or
                ...
                $authUser->can('admin_reportssds') or
