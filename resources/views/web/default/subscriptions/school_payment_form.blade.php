...
<div class="payment-options-holder panel-border bg-white rounded-sm p-25 mb-40 mt-30">
    <form action="/subscribes/paySchoolPayment" method="Post" class="school-payment-form">
        {{ csrf_field() }}
        ...
        <div class="row">
            <div class="col-12 col-lg-12 col-md-12">
                <div class="text-box">
                    ...
                    <p class="mb-10">{{$student_count}} Students</p>
                    <input type="hidden" name="no_of_students"x value="{{$student_count}}">
                    <input type="hidden" class="payment_amount" name="payment_amount" value="{{$payment_amount}}">
                    <input type="hidden" name="package_id" value="{{$packageObj->id}}">
                    <input type="hidden" name="subscribe_for" value="{{$subscribed_for}}">
                    <div class="package-price mb-25" data-price_amount="{{$payment_amount}}"><strong>{{ addCurrencyToPrice(($payment_amount)) }}</strong> for {{$subscribed_for}} days</div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-9 col-md-9 col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="input-field"><input type="text" name="coupon_code" class="coupon_code" placeholder="Enter Code"/></div>
                        </div>
                    </div>
        ...
        <div class="card-gateway-fields-holder">
            ...
            <div class="row mb-10">
                <div class="col-12 col-lg-12 col-md-12 col-sm-12">
					...
					<div class="col-12 col-lg-12 col-md-12 col-sm-12 text-center"><a href="javascript:;" data-user_id="{{isset($user_id)? $user_id : 0}}" data-subscribed_for="{{isset($subscribed_for)? $subscribed_for : 0}}" class="nav-link btn-primary rounded-pill mb-25 process-school-payment">Take me to Payment</a></div>
        ...
        if( coupon_code != ''){
			$.ajax({
				...
				success: function (return_data) {
                    ...
                    $(".payment_amount").val(return_data.package_price);
