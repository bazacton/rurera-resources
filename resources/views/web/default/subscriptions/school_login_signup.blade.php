...
<div class="form-login-reading pt-30">
    <div class="container">
        <form class="school-signup-form" method="post" action="/school-signup-submit" autoComplete='off'>
            {{ csrf_field() }}
            <div class="col-12 col-lg-12 col-md-12 col-sm-12 text-center mb-30"><h1 class="font-40">School details</h1>
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 mx-auto row">
                    ...
                    <div class="col-12 col-lg-6 col-md-6 col-sm-12">
                        <span class="form-label d-block mb-10">School Name</span>
                        <div class="form-group">
                            <div class="input-field">
                                <span class="icon-box">
                                    <img src="/assets/default/img/file.jpg" alt="file">
                                </span>
                                <input type="text" autocomplete="off" name="school_name" class="rurera-req-field" placeholder="School Name"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="form-group">
                            <a href="javascript:;" class="nav-link btn-primary rounded-pill mb-25 text-center school-signup-btn-submit">
                                continue
                            </a>
                        </div>
                    </div>
