    ...
    <div class="course-reviews-box row align-items-center">
        ...
        <div class="col-9">
            <div class="d-flex align-items-center">
                ...
                <span class="ml-15 font-16 text-gray text-left">{{ trans('product.content_quality') }} ({{ $bundle->reviews->count() > 0 ? round($bundle->reviews->avg('content_quality'), 1) : 0 }})</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-16 text-gray text-left">{{ trans('product.instructor_skills') }} ({{ $bundle->reviews->count() > 0 ? round($bundle->reviews->avg('instructor_skills'), 1) : 0 }})</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-16 text-gray text-left">{{ trans('product.purchase_worth') }} ({{ $bundle->reviews->count() > 0 ? round($bundle->reviews->avg('purchase_worth'), 1) : 0 }})</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-16 text-gray text-left">{{ trans('product.support_quality') }} ({{ $bundle->reviews->count() > 0 ? round($bundle->reviews->avg('support_quality'), 1) : 0 }})</span>
            </div>
