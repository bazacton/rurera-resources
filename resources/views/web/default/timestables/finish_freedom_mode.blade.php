        ...
        <ul>
            ...
            <li>
                <div class="quests-item">
                    ...
                    <div class="item-text">
                        <h5 class="font-16 font-weight-bold text-dark-charcoal">Play times table Power-Up Mode for 1 minute.</h5>
                        <div class="levels-progress horizontal">
                            <span class="progress-box">
            ...
            <li>
                <div class="quests-item">
                    ...
                    <div class="item-text">
                        <h5 class="font-16 font-weight-bold text-dark-charcoal">Invite 1 friend to get X600&nbsp;Coins</h5>
                        <div class="levels-progress horizontal">
                            <span class="progress-box">
            ...
            <li>
                <div class="quests-item">
                    ...
                    <div class="item-text">
                        <h5 class="font-16 font-weight-bold text-dark-charcoal">Rate Rurera on play store to get X500&nbsp;Coins</h5>
                        <div class="levels-progress horizontal">
                            <span class="progress-box">
