    ...
    <div class="categories-boxes row">
        <div class="col-12">
            <div class="subjects-heading mb-15">
                <h2 class="font-22 mb-0">Subjects - {{$categoryObj->getTitleAttribute()}}</h2>
            </div>
        </div>
        <div class="col-12">
                ...
                @foreach( $courses_list as $courseObj)
                    ...
                    <div class="categories-card medium panel-border bg-white rounded-sm mb-15">
                        ...
                        <div class="categories-text">
                            ...
                            @else
                                <a href="/{{$courseObj->subject->slug}}/{{$categoryObj->slug}}" class="learning-btn font-14" aria-label="Start Learning Science course">Start Learning</a>
                            @endif
