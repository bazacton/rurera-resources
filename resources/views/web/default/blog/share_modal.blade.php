<div class="d-none" id="blogShareModal">
    ...
    <div class="text-center">
        ...
        <p class="mt-20 font-16">{{ trans('update.share_this_post_with_others') }}</p>
        ...
        <div class="position-relative d-flex align-items-center justify-content-between p-15 mt-15 border border-gray250 rounded-sm mt-5">
            <div class="js-blog-share-link font-weight-bold px-16 text-ellipsis font-16">{{ url($post->getUrl()) }}</div>

            <button type="button" class="js-blog-share-link-copy btn btn-primary btn-sm font-16 font-weight-500 flex-none" data-toggle="tooltip" data-placement="top" title="{{ trans('public.copy') }}">{{ trans('public.copy') }}</button>
        </div>
