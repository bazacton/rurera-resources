            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-md-7 col-lg-7">
                        <a href="/blog"
                           class="post-back-btn font-18 font-weight-normal"
                           itemprop="url">
                            Back to blog
                        </a>

                        <h1 class="font-weight-bold my-20" itemprop="headline">
                            {{ $post->title }}
                        </h1>
                        ...
                        <div class="post-date rurera-hide">
                            <time class="mt-15 d-block font-16"
                        ...
                        <!-- Share bar -->
                        <div class="sharebar mb-0 mt-15" role="group" aria-label="Share this article">
                            ...
                            <button type="button" class="btn btn--fb" aria-label="Share on Facebook">
                                <span class="btn__icon" aria-hidden="true">
                                    <img src="/assets/default/svgs/facebook2.svg" alt="">
                                </span>
                            ...
                            <button type="button" class="btn btn--x" aria-label="Share on Twitter">
                                <span class="btn__icon" aria-hidden="true">
                                    <img src="/assets/default/svgs/twitter-x.svg" alt="">
                                </span>
                                <span class="btn__text">Share on Twitter</span>
                            </button>

                            <div class="share-secondary">
                                <button type="button" class="btn-pinterest" aria-label="Share on Pinterest">
                                    <img src="/assets/default/svgs/pinterest.svg" alt="Pinterest">
                                </button>
                                <button type="button" class="btn-whatsapp" aria-label="Share on WhatsApp">
                                    <img src="/assets/default/svgs/whatsapp.svg" alt="WhatsApp">
                                </button>
                                <button type="button" class="btn-email" aria-label="Share via Email">
                                    <img src="/assets/default/svgs/envelope2.svg" alt="Email">
                                </button>
                            </div>
                            ...
                            <button class="btn btn--share"
                                ...
                                <span class="btn__icon" aria-hidden="true">
                                    <img src="/assets/default/svgs/share2.svg" alt="">
                                </span>
                            </button>
                        </div>
                    </div>

                    <div class="col-12 col-md-5 col-lg-5 ml-auto">
                        <div class="img-box">
                            <img src="{{ $post->image }}"
                                 class="img-cover img-lg"
                                 alt="{{ $post->title }}"
                                 title="{{ $post->title }}"
                                 itemprop="image"
                                 loading="eager">
