...
<section class="blog-sub-header rurera-call-to-action position-relative page-sub-header pt-70 pb-70 overflow-hidden">
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-8 col-md-8">
                                    <div class="cell-inner">
                                        <h1 class="mb-15">Your Guide to <br /> Learning Success</h1>
                                        <p class="mb-0">Helping parents and students learn and prepare with confidence.</p>
    ...
    <section class="rurera-categories-section pt-70">
        <div class="container">
            <div class="row">
    ...
    <section class="rurera-newsletter blog-newsletter mt-70 py-100">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="row justify-content-center align-items-center">
                        <div class="col-12 col-lg-5 col-md-7">
                            ...
                            <div class="rurera-btn-group mt-30 ">
                                <a href="{{url('/')}}/register" class="rurera-btn rounded-pill text-white border-white">Signup</a>
                            </div>
                        </div>
                    </div>
                </div>
