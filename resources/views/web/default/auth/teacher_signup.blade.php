        ...
        <div class="login-container mt-0">
            ...
            <div class="col-12 col-md-6">
                <div class="login-card mt-20 mb-10">
                    <h1 class="font-20 font-weight-bold">{{ trans('auth.signup') }} as Teacher</h1>

                    <form method="post" action="/signup-teacher/register" class="mt-35">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-field">
                                ...
                                <input name="email" value="{{$email}}" readonly type="text" class="form-control" autocomplete="off" placeholder="Where can we reach you? (e.g., you@domain.com)">
                            </div>
                        </div>
                    ...
                    <div class="text-center mt-20">
                        <span class="text-secondary">
                            ...
                            <a href="/admin/login" class="text-secondary font-weight-bold">{{ trans('auth.login') }}</a>
                        </span>
                    </div>
