        ...
        <div class="container h-100">
            <div class="row h-100">
                <div class="col-12 col-lg-6 col-md-6">
                    ...
                    <div class="align-items-center d-flex"><a href="https://rurera.com/pricing" class="text-white bg-primary justify-content-center register-btn try-rurera-btn">Try Rurera for free</a></div>
                </div>
            </div>
        </div>
