        ...
        <div class="row">
            <div class="grid-item col-lg-3 col-md-3 col-sm-6">
                <div class="img-holder">
                    <figure>
                        <img src="/assets/default/img/staff-1.jpg" alt="default staff image" title="default staff image" width="192" height="157" itemprop="image" loading="eager">
                    </figure>
                </div>
            </div>
            <div class="grid-item col-lg-3 col-md-3 col-sm-6">
                <div class="img-holder">
                    <figure>
                        <img src="/assets/default/img/staff-6.jpg" alt="default staff image" title="default staff image" width="192" height="157" itemprop="image" loading="eager">
                    </figure>
                </div>
            </div>
            <div class="grid-item col-lg-3 col-md-3 col-sm-6">
                <div class="img-holder">
                    <figure>
                        <img src="/assets/default/img/staff-4.jpg" alt="default staff image" title="default staff image" width="192" height="284" itemprop="image" loading="eager">
                    </figure>
                </div>
            </div>
            <div class="grid-item col-lg-3 col-md-3 col-sm-6">
                <div class="img-holder">
                    <figure>
                        <img src="../assets/default/img/staff-5.jpg" alt="default staff image" title="default staff image" width="192" height="193" itemprop="image" loading="eager">
                    </figure>
                </div>
            </div>
            ...
            <div class="grid-item col-lg-3 col-md-3 col-sm-6">
                <div class="img-holder">
                    <figure>
                        <img src="/assets/default/img/staff-2.jpg" alt="default staff image" title="default staff image" width="192" height="288" itemprop="image" loading="eager">
                    </figure>
                </div>
            </div>
            <div class="grid-item col-lg-3 col-md-3 col-sm-6">
                <div class="img-holder">
                    <figure>
                        <img src="/assets/default/img/staff-3.jpg" alt="default staff image" title="default staff image" width="192" height="284" itemprop="image" loading="eager">
                    </figure>
                </div>
            </div>
            <div class="grid-item col-lg-3 col-md-3 col-sm-6">
                <div class="img-holder">
                    <figure>
                        <img src="/assets/default/img/staff-7.jpg" alt="default staff image" title="default staff image" width="192" height="288" itemprop="image" loading="eager">
                    </figure>
                </div>
            </div>
...
<div class="lms-job-search">
    <section class="lms-search-services mb-0 pt-80 has-no-bg">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="lms-accordion-job accordion" id="accordionExample">
                        ...
                        <div class="card">
                            <div class="card-header" id="heading_77">
                                <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse_77" aria-expanded="false" aria-controls="collapse_7">
                        ...
                        <div class="card">
                            <div class="card-header" id="heading_78">
                                <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse_78" aria-expanded="false" aria-controls="collapse_7">
                                    QA Analyst
                                    <small>Freelance / online / on-site</small>
                                </button>
                            </div>
