        ...
        <div class="course-private-content text-center w-100 border rounded-lg">
            ...
            @if(!empty($userNotAccess) and $userNotAccess)
                <div class="mt-30">
                    ...
                    <p class="font-16 font-weight-500 text-gray">{{ trans('update.not_access_to_content_hint') }}</p>
                </div>
            @else
                <div class="mt-30">
                    <h2 class="font-20 font-weight-bold text-dark-blue">{{ trans('update.private_content') }}</h2>
                    <p class="font-16 font-weight-500 text-gray">{{ trans('update.private_content_login_hint') }}</p>
                </div>
