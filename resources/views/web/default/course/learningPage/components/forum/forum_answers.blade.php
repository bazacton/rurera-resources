<section class="p-15 m-15 border rounded-lg">
    ...
    <span class="d-block font-16 font-weight-500 text-gray mt-5">{{ trans('public.by') }} <span class="font-weight-bold">{{ $courseForum->user->get_full_name() }}</span> {{ trans('public.in') }} {{ dateTimeFormat($courseForum->created_at, 'j M Y | H:i') }}</span>
            ...
            <div class="d-flex flex-wrap">
                <div class="col-12 col-md-3">
                    <div class="position-relative bg-info-light d-flex flex-column align-items-center justify-content-center rounded-lg w-100 h-100 p-20">
                        ...
                        <h4 class="font-16 text-secondary mt-15 font-weight-bold">{{ $user->get_full_name() }}</h4>
