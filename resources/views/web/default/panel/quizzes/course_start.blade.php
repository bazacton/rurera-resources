...
// $target_score defines the minimum score a user should aim for, defaulting to 100 if not specified.
                   ...
                   {{--Button to navigate to the next question--}}
                                <div class="prev-next-controls text-center mb-50 questions-nav-controls">
                                    <a href="javascript:;" data-toggle="modal" class="review-btn rurera-hide1" data-target="#review_submit">
                                        Finish
                                        <img src="/rurera-resources/public/assets/default/svgs/finish.svg" alt="finish-flag">
                                    </a>
                                    <a href="javascript:;" id="next-btn" class="rurera-hide next-btn">
                                        Next
                                        <img src="/assets/default/svgs/right-arrow.svg" alt="next-btn">
                                    </a>
                                    ...
                                    <a href="javascript:;" id="question-next-btn" class="question-next-btn rurera-hide">
                                        Next
                                        <img src="/assets/default/svgs/left-arrow.svg" alt="previous-btn">
                                    </a>
                                </div>
                            </div>
