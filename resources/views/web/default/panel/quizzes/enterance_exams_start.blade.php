            ...
            <div class="justify-content-center row">
                <div class="col-lg-9 col-md-12 col-sm-12 mx-auto">
                    ...
                    <div data-total_questions="{{count($questions_layout)}}" class="question-area-block" data-active_question_id="{{$active_question_id}}" data-questions_layout="{{json_encode($questions_layout)}}">
                        <button class="status-bar-on-off" type="button" data-toggle="collapse" data-target="#statusbar-data" aria-expanded="false" aria-controls="statusbar-data"><span class="rurera-hide">Hide</span> <span class="show-label">Show</span> Status</button>
