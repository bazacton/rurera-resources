...
<div class="dashboard-students-holder">
    <section class="member-card-header pb-50">
        <div class="d-flex align-items-center justify-content-between flex-md-row">
            ...
            <div class="dropdown">
                <button type="button" class="btn subscription-modal font-16 {{($childs->count() == 0)? 'add-child-btn' : ''}}" data-type="child_register" data-id="0">
                    <img src="/assets/default/svgs/add-con.svg" alt="add-con" height="800" width="800"> Add Student
                </button>
                <button type="button" class="btn link-student-modal p-0 font-16 rurera-hide" data-type="child_register" data-id="0">
                                    ...
                                    <div class="table-sm">
                                        <table class="students-table">
                                            ...
                                            <tr>
                                                ...
                                                <th>
                                                    <h6 class="font-16 font-weight-500">Year</h6>
                                                </th>
                                                <th>
                                                        ...
                                                        <tr class="list-group-item {{$is_cancelled}}">
                                                            ...
                                                            <td data-th="Membership">
                                                                ...
                                                                <span class="font-14 d-block">
                                                                    ...
                                                                    @else
                                                                        <br><a href="javascript:;" class="package-payment-btn package-update-btn subscription-modal" data-type="update_package" data-id="{{$childObj->id}}">
                                                                            Update Package
                                                                        </a>
                                                                    @endif
                                                                    @else
...
<div class="modal fade edit-user-modal rurera-choose-membership" id="edit-user-modal" tabindex="-1"
