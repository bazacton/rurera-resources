...
.rurera-hide{display:none !important;}
    ...
    .emoji-icons {display: flex; gap: 8px; flex-wrap: wrap; align-items: flex-start; }
...
if( !empty( $emojisArray ) ){
	$emoji_response .= '<div class="emoji-icons emoji-icons-ajax">';
...
<div class="user-detail user-view-profile">
    <div class="detail-header-profile bg-white py-25 px-30 d-flex align-items-center flex-wrap justify-content-between mb-25 pb-25">
        ...
        <div class="profile-controls d-inline-flex align-items-center flex-wrap">
            ...
            <a href="javascript:;" class="rurera-hide package-payment-btn font-weight-500 unlink-modal" data-type="child_payment" data-id="{{$user->id}}">
                <span class="icon-box d-inline-block mr-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-lg-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-field">
                                        <input type="text" class="rurera-req-field rureradatepicker" placeholder="Date of Birth" name="dob" value="{{$user->dob}}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="select-field">
                                        <select class="form-control rurera-req-field" name="test_prep_school">
                                            <option value="Not sure" {{($user->prep_school == 'Not sure')? 'selected' : ''}}>Not sure</option>
                                            <option value="Independent schools" {{($user->prep_school == 'Independent schools')? 'selected' : ''}}>Independent schools</option>
                                            <option value="Grammar schools" {{($user->prep_school == 'Grammar schools')? 'selected' : ''}}>Grammar schools</option>
                                            <option value="Independent & grammar schools" {{($user->prep_school == 'Independent & grammar schools')? 'selected' : ''}}>Independent & grammar schools</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12">
                ...
                <div class="edit-info-list">
                    ...
                    <div class="login-controls d-flex align-items-center justify-content-end ml-auto">
                        <a href="javascript:;" class="reset-btn regenerate-emoji" data-user_id="{{$user->id}}">
                            <span class="icon-box"><img src="/assets/default/svgs/retry.svg" alt="retry"></span>Change Emoji
                        </a>
                        <a href="javascript:;" class="reset-btn regenerate-pin" data-user_id="{{$user->id}}">
                            <span class="icon-box"><img src="/assets/default/svgs/retry.svg" alt="retry"></span>Change Pin
                        </a>
                    </div>
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                ...
                <div class="edit-info-list d-flex align-items-center flex-wrap">
                    ...
                    @if( isset( $user->userSubscriptions->id))
                        <div class="subscribe-plan active current-plan position-relative d-flex flex-column p-20 mb-10 mt-10">
...
<script type="text/javascript">
    ...
    $(document).on('click', '.regenerate-emoji', function (e) {
        ...
        jQuery.ajax({
           ...
           success: function (return_data) {
               ...
               $(".emoji-icons-ajax").html(return_data.emoji_html);
               Swal.fire({
                  icon: 'success',
                  html: return_data.response_html,
    ...
    $(document).on('click', '.regenerate-pin', function (e) {
        ...
        jQuery.ajax({
           ...
           success: function (return_data) {
               rurera_remove_loader($(".child-edit-form"), 'div');
               $(".login-pin-ajax").html(return_data.pin_html);
               Swal.fire({
                  icon: 'success',
                  html: return_data.response_html,
                  showCloseButton: true,
