...
<div class="set-work-container rurera-choose-membership">
    <form action="/set-work/{{ !empty($assignment) ? $assignment->id.'/update' : 'store' }}" method="Post" class="rurera-form-validation p-20">
        {{ csrf_field() }}
        ...
        <div class="wizard-steps active" data-step_id="1">
            <div class="wizard-steps-heading mb-30 text-left">
                <h2 class="font-22 mb-10 test@@">Set Work</h2>
            ...
            <div class="years-group populated-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-6 rurera_common_hide_field smart_score_field  ">
                        <div class="form-group rurera_common_hide_field general-info-block">
                            ...
                            <div class="range-slider">
                                ...
                                <input type="range"
                                       name="ajax[new][smart_score]"
                                       value="0"
                                       class="js-ajax-title form-control smart_score range-slider-field"
