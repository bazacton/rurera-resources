...
<section class="member-card-header pb-20 mb-15">
    <div class="d-flex align-items-center justify-content-between flex-md-row">
        ...
        <div class="dropdown">
            <a class="btn subscription-modal font-16" href="/panel/set-work/create" data-type="child_register"><img src="/assets/default/svgs/add-con.svg" alt="add-con" height="800" width="800"> Add Work
            </a>
        </div>
    </div>
</section>
