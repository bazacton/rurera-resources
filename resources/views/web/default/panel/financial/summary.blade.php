<section>
    <h2 class="section-title mb-10 font-20 font-weight-bold">Memberships</h2>

    <div class="panel-section-card bg-white panel-border rounded-sm p-25">
        <div class="row">
            <div class="col-12">
                <div class="table-responsive transactions-table table-sm transactions-history">
                    <table class="table text-center custom-table">
                        ...
                        @foreach($accountings as $accounting)
                            <tr>
                                ...
                                <td class="text-center align-middle font-15 font-weight-normal text-gray" data-th="{{ trans('public.date') }}">
                        ...
                        <tr class="no-record-found">
                            <td class="text-left font-16 font-weight-normal no-records-found" colspan="4">No Records Found</td>
                        </tr>
                        @endif
                        </tbody>
                    </table>
