    ...
    <div class="col-12 col-md-6 mt-15">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="number" name="duration" value="{{ (!empty($upcomingCourse) and !empty($upcomingCourse->duration)) ? $upcomingCourse->duration : old('duration') }}" class="mt-0 form-control @error('duration')  is-invalid @enderror" min="0"/>
                @error('duration')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
