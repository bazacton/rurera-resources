        ...
        <div class="question-layout-block">
            ...
            <form class="question-fields" action="javascript:;" data-question_id="{{ $question->id }}">
                <div class="left-content has-bg">
                    ...
                    @endif
                    <span class="questions-total-holder d-block mb-30 rurera-hide">( {{$question_no}}/{{$total_questions}} Questions ) <span class="question-dev-details">@if($layout_type != 'results') ({{ $question->id }}) @endif  ({{ $question->question_difficulty_level }}) ({{ $question->question_type }}) ({{ isset( $question->subChapter->id)? $question->subChapter->sub_chapter_title : '' }})</span></span>
