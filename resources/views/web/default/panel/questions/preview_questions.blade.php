                    ...
                    <div class="questions-bar-box">
                        <div class="quiz-questions-bar-holder">
                            <div class="quiz-questions-bar">
                                <span class="value-lable progress-bar-counter" data-title="Smart score" style="left:0%"><span>1 / 1</span></span>
                                                        ...
                                                        <div class="question-right-inner">
                                                            ...
                                                            <div class="question-detail-holder">
                                                                ...
                                                                <ul class="question-details">
                                                                    ...
                                                                    <li>Part Details: <span>{!! isset($questionObj->topicPart->id)? $questionObj->topicPart->paragraph : '' !!}</span></li>
