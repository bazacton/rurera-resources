...
<section>
    ...
    <div class="activities-container p-20 p-lg-35 ">
        <div class="chart-filters p-0">
            <div class="filters-list mb-0">
                ...
                <ul class="analytics-type">
                    ...
                    <li {{($type_selected == 'learn')? 'class=active' : ''}}><a href="/{{panelRoute()}}/analytics/learn{{$link_append}}" data-graph_type="learn"><img src="/assets/default/img/sidebar/learn.svg" height="800" width="800" alt="learn"> LEARN</a></li>
        ...
        <div class="accordion" id="analyticsAccordion">
            ...
            <div class="card">
                <div class="card-header collapsed mb-0" id="headingOne" data-toggle="collapse" data-target="#report_{{$date_str}}" aria-expanded="true" aria-controls="report_{{$date_str}}">
            ...
            @else
                <div class="card">
                    <div class="card-header collapsed mb-0" id="headingOne" data-toggle="collapse" data-target="#report_07_03_2024" aria-expanded="true" aria-controls="report_07_03_2024">
                        <span>&nbsp;</span>
                        <span class="analytics-timespend float-right">
