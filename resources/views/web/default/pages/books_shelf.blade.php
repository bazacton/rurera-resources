...
<section class="position-relative job-singup-sub-header gallery-sub-header pb-0" style="min-height: 620px;">
    <div class="container h-100">
      <div class="row h-100">
        <div class="col-12 col-md-12 col-lg-7">
          <h1 class="font-72 font-weight-bold"> Empower yourself through <br> reading <span class="text-scribble">books</span>
          </h1>
  ...
  <div class="modal fade rurera-choose-membership" id="exampleModal" style="display: none;" aria-hidden="true">
