            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="content-holder card p-25">
                        <ul data-target_class="admin-rurera-tabs-billing" class="col-10 col-md-10 col-lg-10 admin-rurera-tabs nav nav-pills mb-20" id="assignment_tabs" role="tablist" style="display: none;">
