        ...
        <div class="row">
            <div class="col-12 col-md-9 col-lg-9 mx-auto">
                ...
                <div class="q-ai-nav-controls">
                    <a href="#home" class="active skelton-hide skelton-height-lg skelton-mb-0" data-toggle="modal" data-target="#templatesleModal"><img src="/assets/default/svgs/add-question.svg" alt="add-question"> Add Question</a>
                    <a href="#q-collections" class="skelton-hide skelton-height-lg skelton-mb-0" data-toggle="modal" data-target="#templatesleModal"><img src="/assets/default/svgs/add-collection.svg" alt="add-collection"> Add question from Collection</a>
                    <a href="#generate-ai" class="skelton-hide skelton-height-lg skelton-mb-0" data-toggle="modal" data-target="#templatesleModal"><img src="/assets/default/svgs/ai.svg" alt="ai"> Generate quiz using AI</a>
                    <a href="#import-q" class="skelton-hide skelton-height-lg skelton-mb-0" data-toggle="modal" data-target="#templatesleModal"><img src="/assets/default/svgs/import-worksheet.svg" alt="import-worksheet"> Import Worksheets</a>
                </div>
                ...
                <div class="quiz-ai-tags mb-30 bg-white panel-border rounded-sm p-15 alert-dismissible alert fade show">
                    ...
                    <ul>
                        <li class="skelton-hide skelton-height-lg skelton-mb-0"><a href="#"><img src="/assets/default/svgs/ai.svg" alt="">Add similar questions</a></li>
                        <li class="skelton-hide skelton-height-lg skelton-mb-0"><a href="#" data-toggle="modal" data-target="#document-modal"><img src="/assets/default/svgs/ai.svg" alt="">Fix grammatical and spelling errors</a></li>
                        <li class="skelton-hide skelton-height-lg skelton-mb-0"><a href="#"><img src="/assets/default/svgs/ai.svg" alt="">Translate questions</a></li>
                        <li class="skelton-hide skelton-height-lg skelton-mb-0"><a href="#"><img src="/assets/default/svgs/ai.svg" alt="">Simplify questions</a></li>
                        <li class="skelton-hide skelton-height-lg skelton-mb-0"><a href="#"><img src="/assets/default/svgs/ai.svg" alt="">Add questions on particular topic</a></li>
                        <li class="skelton-hide skelton-height-lg skelton-mb-0"><a href="#"><img src="/assets/default/svgs/ai.svg" alt="">Reduce/increase Options From MCQs</a></li>
                        <li class="skelton-hide skelton-height-lg skelton-mb-0"><a href="#"><img src="/assets/default/svgs/ai.svg" alt="">Add learner’s name in the questions</a></li>
                        <li class="skelton-hide skelton-height-lg skelton-mb-0"><a href="#"><img src="/assets/default/svgs/ai.svg" alt="">Add answer's explanation</a></li>
                        <li class="skelton-hide skelton-height-lg skelton-mb-0"><a href="#"><img src="/assets/default/svgs/ai.svg" alt="">Write custom prompt</a></li>
                    </ul>
                </div>
