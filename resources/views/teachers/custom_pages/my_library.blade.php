            ...
            <div class="col-12">
                <div class="staff-picks-tabs skeleton">
                    <div class="mb-30 bg-white panel-border rounded-sm p-15">
                        ...
                        <div class="search-filters mb-0">
                            <div class="select-field skelton-hide skelton-height-lg">
                                <span>By:</span>
                                <select>
                        ...
                        <div class="col-12 col-lg-4 col-md-4">
                            <div class="featured-list-sidebar">
                                <div class="featured-filters">
                                    <div class="text-box skelton-hide skelton-height-lg skelton-mb-0">
                                ...
                                <div class="featured-list-sidebar-inner">
                                    ...
                                    <div class="listing-card mb-15 bg-white panel-border rounded-sm">
                                        <a href="#" class="listing-card-link">
                                            ...
                                            <ul class="list-options">
                                                <li class="skelton-hide skelton-height-lg"><span class="icon-box"><img src="/assets/default/svgs/question-circle.svg" alt="question-circle"></span> 15 questions</li>
                                                <li class="skelton-hide skelton-height-lg"><span class="icon-box"><img src="/assets/default/svgs/grades.svg" alt="grades"></span> 4th-6th Grade</li>
                                                <li class="skelton-hide skelton-height-lg"><span class="icon-box"><img src="/assets/default/svgs/book-saved.svg" alt="book-saved"></span> English</li>
                                            </ul>
                                        </a>
                                    </div>
                                    ...
                                    <div class="listing-card mb-15 bg-white panel-border rounded-sm">
                                        <a href="#" class="listing-card-link">
                                            ...
                                            <div class="text-holder">
                                                <h3 class="skelton-hide skelton-height-lg">History Trivia Quest</h3>
                                                <div class="author-info">
                                                    <span class="info-text">
                                                        <span class="skelton-hide skelton-height-lg">Lucy W</span>
                                                        <span class="skelton-hide skelton-height-lg">2 days ago</span>
                                                    </span>
                                                </div>
                                            </div>
                                            <ul class="list-options">
                                                <li class="skelton-hide skelton-height-lg"><span class="icon-box"><img src="/assets/default/svgs/question-circle.svg" alt="question-circle"></span> 12 questions</li>
                                                ...
                                                <li class="skelton-hide skelton-height-lg"><span class="icon-box"><img src="/assets/default/svgs/book-saved.svg" alt="book-saved"></span> History</li>
                                            </ul>
                                        </a>
                                    </div>
                                    ...
                                    <div class="listing-card mb-15 bg-white panel-border rounded-sm">
                                        <a href="#" class="listing-card-link">
                                            ...
                                            <div class="text-holder">
                                                <h3 class="skelton-hide skelton-height-lg">Artistic Impressions Puzzle</h3>
                                                <div class="author-info">
                                                    <span class="info-text">
                                                        <span class="skelton-hide skelton-height-lg">Sara L</span>
                                                        <span class="skelton-hide skelton-height-lg">3 days ago</span>
                                                    </span>
                                                </div>
                                            </div>
                                            <ul class="list-options">
                                                <li class="skelton-hide skelton-height-lg"><span class="icon-box"><img src="/assets/default/svgs/question-circle.svg" alt="question-circle"></span> 5 questions</li>
                                                <li class="skelton-hide skelton-height-lg"><span class="icon-box"><img src="/assets/default/svgs/grades.svg" alt="grades"></span> 1st-3rd Grade</li>
                                                <li class="skelton-hide skelton-height-lg"><span class="icon-box"><img src="/assets/default/svgs/book-saved.svg" alt="book-saved"></span> Art</li>
                                            </ul>
                                        </a>
                                    </div>
                                    ...
                                    <div class="listing-card mb-15 bg-white panel-border rounded-sm">
                                        <a href="#" class="listing-card-link">
                                            ...
                                            <div class="text-holder">
                                                <h3 class="skelton-hide skelton-height-lg">Science Exploration Mission</h3>
                                                <div class="author-info">
                                                    <span class="info-text">
                                                        <span class="skelton-hide skelton-height-lg">Alex P</span>
                                                        <span class="skelton-hide skelton-height-lg">5 hours ago</span>
                                                    </span>
                                                </div>
                                            </div>
                                            <ul class="list-options">
                                                <li class="skelton-hide skelton-height-lg"><span class="icon-box"><img src="/assets/default/svgs/question-circle.svg" alt="question-circle"></span> 8 questions</li>
                                                <li class="skelton-hide skelton-height-lg"><span class="icon-box"><img src="/assets/default/svgs/grades.svg" alt="grades"></span> 2nd-5th Grade</li>
                                                <li class="skelton-hide skelton-height-lg"><span class="icon-box"><img src="/assets/default/svgs/book-saved.svg" alt="book-saved"></span> Science</li>
                                            </ul>
                                        </a>
                                    </div>
                                    ...
                                    <div class="listing-card mb-15 bg-white panel-border rounded-sm">
                                        <a href="#" class="listing-card-link">
                                            ...
                                            <div class="text-holder">
                                                <h3 class="skelton-hide skelton-height-lg">Geography World Challenges</h3>
                                                <div class="author-info">
                                                    <span class="info-text">
                                                        <span class="skelton-hide skelton-height-lg">Chris B</span>
                                                        <span class="skelton-hide skelton-height-lg">4 hours ago</span>
                                                    </span>
                                                </div>
                                            </div>
                                            <ul class="list-options">
                                                <li class="skelton-hide skelton-height-lg"><span class="icon-box"><img src="/assets/default/svgs/question-circle.svg" alt="question-circle"></span> 6 questions</li>
                                                <li class="skelton-hide skelton-height-lg"><span class="icon-box"><img src="/assets/default/svgs/grades.svg" alt="grades"></span> 5th-7th Grade</li>
                                                <li class="skelton-hide skelton-height-lg"><span class="icon-box"><img src="/assets/default/svgs/book-saved.svg" alt="book-saved"></span> Geography</li>
                                            </ul>
                                        </a>
                                    </div>
                                    ...
                                    <div class="listing-card mb-15 bg-white panel-border rounded-sm">
                                        <a href="#" class="listing-card-link">
                                            ...
                                            <ul class="list-options">
                                                <li class="skelton- skelton-height-lg"><span class="icon-box"><img src="/assets/default/svgs/question-circle.svg" alt="question-circle"></span> 10 questions</li>
                                                <li class="skelton-hide skelton-height-lg"><span class="icon-box"><img src="/assets/default/svgs/grades.svg" alt="grades"></span> 5th-8th  Grade</li>
                                                <li class="skelton-hide skelton-height-lg"><span class="icon-box"><img src="/assets/default/svgs/book-saved.svg" alt="book-saved"></span> Physics</li>
                                            </ul>
                                        </a>
                        ...
                        <div class="col-12 col-lg-8 col-md-8">
                            <div class="elements-holder bg-white panel-border p-15 border-bottom-0 rounded-sm-tr">
                                <div class="questions-header">
                                    <div class="questions-header-inner">
                                        ...
                                        <div class="questions-header-controls skelton-hide skelton-height-lg skelton-mb-0">
                                            <button type="button"><i class="fas fa-plus"></i> Add All</button>
                                        </div>
                                    </div>
                                </div>
                                <ul class="list-options question-list-options mb-15">      
                                    <li class="skelton-hide skelton-height-lg skelton-mb-0"><span class="icon-box"><img src="/assets/default/svgs/question-circle.svg" alt="question-circle"></span> 8 questions</li>
                                    <li class="skelton-hide skelton-height-lg skelton-mb-0"><span class="icon-box"><img src="/assets/default/svgs/save.svg" alt="save"></span> 7th-8th  Grade</li>
                                    <li class="skelton-hide skelton-height-lg skelton-mb-0"><span class="icon-box"><img src="/assets/default/svgs/book-saved.svg" alt="book-saved"></span> Science</li>
                                </ul>
                                <div class="class-controls">
                                    <div class="left-area d-inline-flex align-items-center">
                                        <div class="class-controls-option questions-control-options border-0 mr-0 pr-0 d-inline-flex align-items-center">
                                            <button type="button" class="skelton-hide skelton-height-lg skelton-mb-0"><img src="/assets/default/svgs/edit-simple.svg" alt="edit-simple">Copy & edit</button>
                                            <button type="button" class="skelton-hide skelton-height-lg skelton-mb-0"><img src="/assets/default/svgs/save.svg" alt="save">Save</button>
                                            <button type="button" class="skelton-hide skelton-height-lg skelton-mb-0"><img src="/assets/default/svgs/share.svg" alt="share">Share</button>
                                            <button type="button" class="skelton-hide skelton-height-lg skelton-mb-0"><img src="/assets/default/svgs/download.svg" alt="download">Worksheet</button>
                                            <div class="dropdown-box skelton-hide skelton-height-lg skelton-mb-0">
                                                <div class="dropdown">
                                    ...
                                    <div class="right-area w-auto">
                                        <button type="button" class="assignment-btn skelton-hide skelton-height-lg skelton-mb-0"><img class="show-img" src="/assets/default/svgs/clock.svg" alt="clock"> Assign</button>
                                        <button type="button" class="perview-btn skelton-hide skelton-height-lg skelton-mb-0" data-toggle="modal" data-target="#document-modal"><img class="show-img" src="/assets/default/svgs/eye-show.svg" alt="eye-show"> Perview</button>
                                    </div>
                                </div>
                            </div>
                            <div class="question-layout-holder mb-0 bg-white panel-border p-25 border-bottom-0">
                                ...
                                <div class="view-explanation skelton-hide">
                                    <div class="explanation-controls d-flex align-items-center">
                                        <button class="collapsed skelton-hide skelton-height-lg skelton-mb-0" type="button" data-toggle="collapse" data-target="#explanation-list1" aria-expanded="false" aria-controls="explanation-list">
                                            ...
                                            <div class="rureraform-admin-popup active" id="rureraform-element-properties" style="display: block;" data-element_id="rureraform-element-3">
                                                <div class="rureraform-admin-popup-inner">
                                                    <div class="rureraform-admin-popup-title">
                                                        ...
                                                        <h3><i class="fas fa-cog element-properties-label"></i> Multiple Choice 1</h3>
                                                    </div>
                                                    <div class="rureraform-admin-popup-content">
                                                        ...
                                                        <div id="rureraform-tab-basic" class="rureraform-tab-content" style="display: block;">
                                                            ...
                                                            <div class="rureraform-properties-content">
                                                                ...
                                                                <select name="rureraform-image_position" id="rureraform-image_position">
                            ...
                            <div class="mb-0 bg-white panel-border p-25 border-bottom-0">
                                        ...
                                        <div class="left-content has-bg">
                                            ...
                                            <div id="rureraform-form-1" class=" rureraform-form rureraform-elements rureraform-form-input-medium rureraform-form-icon-inside rureraform-form-description-bottom ui-sortable" _data-parent="1" _data-parent-col="0" style="display: block;">
                                                ...
                                                <div class="rureraform-col rureraform-col-12">
                                                    <div class="rureraform-element quiz-group rureraform-element-html ui-sortable-handle">
                                                        <div class="question-top-info">
                                                            <div class="question-count skelton-hide skelton-height-lg">
                                                                <span class="icon-box"><img src="/assets/default/svgs/question-simple.svg" alt="question-simple"></span>
                                                                <span class="question-count-lable">Question 1 of 20</span>
                                                            </div>
                                                            <div class="question-info">
                                                            ...
                                                            <div class="rureraform-input rureraform-cr-layout rureraform-cr-layout">
                                                                <div class="form-box ">
                                                                    <div class="lms-radio-select rurera-in-row justify-content-end">
                                                                        <div class="form-field rureraform-cr-container-medium rureraform-cr-container-undefined active-option skelton-hide skelton-height-lg skelton-mb-0">
                                ...
                                <div class="view-explanation">
                                    <div class="explanation-controls d-flex align-items-center">
                                        <button class="collapsed skelton-hide skelton-height-lg skelton-mb-0" type="button" data-toggle="collapse" data-target="#explanation-list2" aria-expanded="false" aria-controls="explanation-list">
                                            <i class="fas fa-plus"></i> Explanation
                                        </button>
                                    </div>
                            ...
                            <div class="mb-15 bg-white panel-border p-25">
                                ...
                                <div class="view-explanation">
                                    <div class="explanation-controls d-flex align-items-center">
                                        <button class="collapsed skelton-hide skelton-height-lg skelton-mb-0" type="button" data-toggle="collapse" data-target="#explanation-list3" aria-expanded="false" aria-controls="explanation-list">
                                            <i class="fas fa-plus"></i> Explanation
                                        </button>
                                    </div>
