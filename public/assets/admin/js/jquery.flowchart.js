...
// "colorize" the widget name
    $.widget("flowchart.flowchart", {
        ...
        _create: function () {
            ...
            //this.objs.layers.operators = $('.book-dropzone.active');
        ...
        createLink: function (linkId, linkDataOriginal) {
            ...
            var element_id = linkDataOriginal.fromOperator;
            ...
            this._drawLink(linkId, element_id);
        ...
        _drawLink: function (linkId, element_id = 0) {
            var linkData = this.data.links[linkId];
            ...
            group.setAttribute('class', 'flowchart-link path_'+element_id);
            group.setAttribute('data-link_id', linkId);
            group.setAttribute('data-element_id', element_id);
            ...
            shape_path.setAttribute("stroke-width", 2);
        ...
        _getOperatorFullElement: function (operatorData, declaredFullElement = null) {
            var infos = this.getOperatorCompleteData(operatorData);

            if(declaredFullElement == null) {
                ...
                $operator_body = $('.book-dropzone.active');
                $operator_title = declaredFullElement.attr('data-item_title');
                $operator = declaredFullElement;
                $operator_inputs = declaredFullElement.find('.flowchart-operator-inputs');
                $operator_outputs = declaredFullElement.find('.flowchart-operator-outputs');
            }
        ...
        createOperator: function (operatorId, operatorData, declaredFullElement = null) {
            operatorData.internal = {};
            this._refreshInternalProperties(operatorData);
            var fullElement = this._getOperatorFullElement(operatorData, declaredFullElement);
            console.log('fullElementfullElement');
            ...
            console.log('this.options.canUserMoveOperators');
            console.log(operatorData.internal.properties.uncontained ? false : this.element);
            //this.options.canUserMoveOperators = false;
