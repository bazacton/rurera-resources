            ...
            $(".rureradatepicker").length > 0 &&
                $(".rureradatepicker").each(function () {
                    ...
                    var r = {
                        ...
                        autoUpdateInput: !1,
                        drops: t,
                        parentEl: e.closest('.years-group')
                    };
...
function scroll_cb() {
    ...
    $(window).scrollTop(),
        ...
        $("h2[id], ul[id], h3[id]").each(function (t, a) {
            ...
            if (e > n - 50 && e < n + r) {
                var i = $(a).attr("id");
                $(".single-post-nav li a[href='#" + i + "']").length > 0 &&
                    ($(".single-post-nav li a.current").removeClass("current"),
                    $(".single-post-nav li a[href='#" + i + "']").addClass("current"));
            }
        });
}
