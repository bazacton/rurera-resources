function rurera_loader(e, t) {
	switch (t) {
		...
		case "animation":
			...
			(a = 4),
			$("body").append(
				'<div class="rurera-button-loader" style="display: block;">\n                        <div class="preloader"><img src="/assets/default/img/preloaders/' +
				a +
				'.webp"><span class="preloader-text">Sharpen your wits and get ready to unravel mind-bending questions and brain teasers in our upcoming quiz</span></div>\n                    </div>'
			);
	}
}
...
function rurera_remove_loader(e, t) {
	switch (t) {
		case "button":
			e.removeClass("rurera-processing"), e.unwrap(".rurera-loader-holder"), $("body").removeClass("rurera-processing"), $("body").find(".rurera-button-loader").remove();
			break;
		case "div":
...
function FieldIsEmpty(e) {
	return (is_empty = !0), "" != e && "undefined" != e && void 0 != e && (is_empty = !1), is_empty;
}
$(document).ready(function() {
	...
	$(document).ready(function() {
		function e() {
			992 > $(window).width() ? $("body").css("padding-top", $(".panel-right-sidebar").innerHeight()) : $("body").css("padding-top", 0);
		}
	...
	$(".show-more-btn").click(function() {
		$(".lms-chapter-ul-outer ul").hasClass("show-more-items") ? $(this).text("Show More") : $(this).text("Show Less"), $(this).siblings(".lms-chapter-ul-outer ul").toggleClass("show-more-items");
	}),
	$(window).load(function() {
		jQuery(".masonry-grid").length > 0 && $(".masonry-grid").masonry({
	...
	$(document).ready(function() {
		$(window).scroll(function() {
			...
			$(".round").click(function(e) {
				return e.preventDefault(), e.stopPropagation(), $(".arrow").toggleClass("bounceAlpha"), $("html, body").animate({
					scrollTop: 0
				}, 600), !1;
			}),
			$(function() {
			...
			$(document).ready(function() {
				(t = {
					...
					Lists: [{
							...
							list: ["1,0009,909", "1,023,065", "1,0009,908", "1,230,650"]
						},
						{
							name: "Available Fields",
							list: ["1st", "2nd", "4th", "3rd"]
						},
					],
				}),
			...
			$(".read-text-btn").click(function() {
				(curSize = parseInt($(".quiz-info-inner p").css("font-size")) + 1) <= 24 ? $(".quiz-info-inner p").css("font-size", curSize) : $(".quiz-info-inner p").css("font-size", "15px");
			}),
		...
		var e,
			t,
			a,
			n = document.getElementById("highlights");
		jQuery(".text-highlight-btn").length > 0 &&
			$(".text-highlight-btn").on("click", function(e) {
				...
				var t = (function e(t) {
						...
						if (void 0 !== window.getSelection) {
							...
							var i = 0,
								s = a.match(/^[\s"']+/);
							if ((s && (i = s[0].length), "" === (a = a.replace(/^[\s"']+/, "")))) alert("Error: you must select at least one character"), (tartOffset = 0), (endOffset = 0), (a = "null");
							else {
								var o = parseInt(1e4 * Math.random()),
									l = document.createElement("span");
								l.classList.add("chosen");
								var c = "i" + o;
								l.setAttribute("data-cid", c), l.appendChild(r.extractContents()), (l.style.backgroundColor = t), r.insertNode(l);
							}
						}
						return {
							text: a,
				...
				s.appendChild(i), s.setAttribute("data-cid", r), s.classList.add("highlighted"), n.appendChild(s);
			}),
			jQuery(".quiz-info-inner").length > 0 &&
			$(".quiz-info-inner").on("dblclick", ".chosen", function() {
				var e = this.getAttribute("data-cid");
				n.querySelector("[data-cid=" + e + "]").remove(), this.replaceWith(this.innerText);
			}),
			$(document).ready(function() {
				var e,
					t,
				...
				$(".lms-accordion-simple .card").click(function() {
					...
					$(".has-mega-menu .nav-link").click(function(e) {
						$(".lms-mega-menu").slideToggle(), $(".lms-mega-menu").toggleClass("menu-open"), e.preventDefault();
					}),
					992 > $("body").width() &&
					((e = ""),
						(t = ""),
						...
						.each(function(r) {
							...
							$(e).removeAttr("role"),
								...
								(a = $(e).html()),
								$(e).html(""),
								$(e).prepend('<div class="panel-heading"><h4 class="panel-title"><a data-toggle="collapse" data-parent="' + e + '" href="' + e + '1">' + n + "</a></h4></div>"),
								$(e).append('<div id="' + e.substring(1, e.length) + '1" class="panel-collapse collapse ' + t + '"><div class="panel-body"> ' + a + "</div></div>");
						}),
						$(r).find(".mega-menu-nav").remove()),
					$(".mega-menu-body .panel").each(function() {
						$(this).has(".panel-collapse").length && $(".panel-heading .panel-title a").addClass("collapsed");
					}),
			...
			$(document).on("click", ".mega-menu-nav a", function() {
				...
				$("body").get(0).style.setProperty("--category-color", t), $(".mega-menu-head").attr("class", "mega-menu-head"), $(".mega-menu-head").addClass(e);
			}),
			...
			$(document).ready(function() {
				$(".widget-title").click(function() {
					$(this).toggleClass("active").next(".widget-body").slideToggle().parent().siblings().find(".widget-body").slideUp().prev().removeClass("active");
				});
			});
	}),
	$(document).on("submit", ".create_student_form", function(e) {
		return !1 != (returnType = rurera_validation_process($(this))) && (rurera_loader($(this).find(".submit-button"), "div"), !0);
	}),
	...
	$(document).on("click", ".user-assignments-tab", function(e) {
		...
		rurera_loader($("#" + a), "div"),
			jQuery.ajax({
				...
				success: function(e) {
					$("#" + a + " .assignments-list ul").html(e), console.log(a), rurera_remove_loader($("#" + a), "div");
				},
			});
	}),
	$(document).ready(function() {
		jQuery(".panel-right-sidebar .navbar-toggler, .panel-sidebar .navbar-toggler").length > 0 &&
			...
			jQuery(".key-statistics .swiper").length > 0 && new Swiper(".key-statistics .swiper", {
				pagination: {
					el: ".swiper-pagination",
					clickable: !0
				}
			...
			// jQuery(".footer-dots-img").length > 0 &&
			// $(window).scroll(function() {
			// 	var e = $(window).scrollTop();
			// 	$(".footer-dots-img").css({
			// 		transform: "scale(" + (145 - e / 100) / 100 + ")"
			// 	});
			// }),
			($.fn.moveIt = function() {
				var t = $(window),
		...
		jQuery("[data-scroll-speed]").length > 0 &&
			...
			$(".filter-mobile-btn").on("click", function(e) {
				$(".filters-list .analytics-type, .tests-list,  .inline-filters").toggleClass("open"), e.preventDefault();
			}),
			...
			jQuery.ajax({
				...
				success: function(e) {
					t.find("img").removeClass("heart-fill"),
						...
						"add" == n && (t.find("img").addClass("heart-fill"), t.find("img").attr("src", "/assets/default/svgs/heart-fill.svg"), t.attr("data-type", "remove")),
						"remove" == n && (t.find("img").addClass("heart-alt"), t.find("img").attr("src", "/assets/default/svgs/heart-alt.svg"), t.attr("data-type", "add")),
...
function generatePassword(e) {
	var t,
		...
		t = n[i] + r[Math.floor(Math.random() * r.length)] + (Math.floor(90 * Math.random()) + 10);
	return t;
}
...
$(document).on("click", ".subscription-modal", function(e) {
	...
	$(document).on("click", ".cancel-subscription-modal", function(e) {
		...
		$(".cancel-package-data").html(a), $(".cancel-package-data .package-data").removeClass("rurera-hide"), $(".cancel-subscription-btn").attr("data-child_id", t), $("#cancelsubscriptionModal").modal("show");
	}),
	...
	$(document).on("click", ".unlink-btn", function(e) {
		...
		rurera_loader($(".unlink-block"), "div"),
			$.ajax({
				...
				success: function(e) {
					$("#unlinkModal").modal("hide"), Swal.fire({
						icon: "success",
    ...
    $(document).on("click", ".school-signup-btn-submit", function(e) {
        if (!1 == (returnType = rurera_validation_process($(".school-signup-form"), "under_field"))) return !1;
        rurera_loader($(".subscription-content"), "div");
        ...
        rurera_loader($(".subscription-content"), "div"),
            $.ajax({
                ...
                error: function e(t) {
                    ...
                    var a = t.responseJSON.errors,
                        n = "";
                    for (var r in a)
                        a.hasOwnProperty(r) &&
                        a[r].forEach(function(e) {
                            (n += e + "<br>"), console.log("Field: " + r + ", Error: " + e);
                        });
                    Swal.fire({
                        icon: "error",
                        html: '<h3 class="font-20 text-center text-dark-blue py-25">' + n + "</h3>",
                        showConfirmButton: !1,
                        width: "25rem"
                    });
                },
	...
	$(document).on("click", ".signup-btn-submit", function(e) {
		if (!1 == (returnType = rurera_validation_process($(".signup-form"), "under_field"))) return !1;
		rurera_loader($(".subscription-content"), "div");
	...
	$(document).on("click", ".packages-back-btn", function(e) {
		...
		rurera_loader($(".subscription-content"), "div"),
			$.ajax({
				...
				success: function(e) {
					rurera_remove_loader($(".subscription-content"), "div"), $(".subscription-content").html(e), $(".subscribed_for-field").change();
				},
			});
	}),
	$(document).on("submit", ".rurera-form-validation", function(e) {
		return new FormData($(".rurera-form-validation")[0]), !1 != (returnType = rurera_validation_process($(".rurera-form-validation"), "under_field"));
	}),
	$(document).on("focusout", ".child-register-form .rurera-req-field", function(e) {
		if ((new FormData($(".child-register-form")[0]), !1 == (returnType = rurera_validation_process($(".child-register-form"), "under_field")))) return !1;
	}),
	$(document).on("submit", ".child-register-form", function(e) {
		var t = new FormData($(".child-register-form")[0]);
		return (
			!1 != (returnType = rurera_validation_process($(".child-register-form"), "under_field")) &&
	...
	$(document).on("submit", ".child-edit-form", function(e) {
		...
		if ((console.log("submission"), !1 == (returnType = rurera_validation_process($(".child-edit-form"), "under_field")))) return !1;
    ...
    $(document).on("click", ".school-package-selection", function(e) {
        ...
        var student_count = $(".student-count").html();
        var t = $(this).attr("data-id"),
        ...
        return (
            console.log(n),
                (selectedPackage = t),
                r.append("selected_package", pkg.package_id),
                r.append("subscribed_for", 1),
                r.append("student_count", student_count),
                rurera_loader($(".subscription-content"), "div"),
                $.ajax({
                    type: "POST",
    ...
    $(document).on("click", ".process-school-payment", function(e) {
        ...
        var form_data = new FormData($(".school-payment-form")[0]);
        $.ajax({
            type: "POST",
            ...
            success: function(response) {
                ...
                // Open Stripe payment in new tab/window
                var paymentWindow = window.open(invoice_url, 'PaymentWindow', `width=${width},height=${height},top=${top},left=${left},resizable=yes,scrollbars=yes`);

                // Start polling every 2 seconds
                var interval = setInterval(function() {
                    $.ajax({
                        url: '/subscribes/check-payment-status', // Update with your actual endpoint
                        method: 'GET',
                        data: {
                            order_id: order_id // Replace with actual payment ID
                        },
                        success: function(data) {
                            if (data.status === 'paid') {
                                ...
                                // Redirect with toast data in query string
                                let toast = encodeURIComponent(JSON.stringify(data.toast));
                                window.location.href = `/admin?toast=${toast}`;
                            }
                        }
                    });
                }, 2000);
...
function createWordCloud(e, t, a) {
	...
	function l(e, t) {
		...
		return (n.style.position = "absolute"), (n.style.fontSize = t + "px"), (n.style.lineHeight = a.lineHeight), n.appendChild(document.createTextNode(e)), n;
	}

	function c(e, t, a) {
		n.appendChild(e), (e.style.left = Math.floor(99 * Math.random()) + 1 + "px"), (e.style.top = Math.floor(100 * Math.random()) + 1 + "px"), o.push(e.getBoundingClientRect());
	}
	...
	function u(e, t, r) {
		n.appendChild(e), (e.style.left = Math.floor(99 * Math.random()) + 1 + "px"), (e.style.top = Math.floor(100 * Math.random()) + 1 + "px"), console.log(e);
		var i = e.getBoundingClientRect();
		n.removeChild(e);
		for (var s = 0; s < o.length; s += 1) {
			var l = o[s];
			if (!(i.right + a.xWordPadding < l.left - a.xWordPadding || i.left - a.xWordPadding > l.right + a.xWordPadding || i.bottom + a.yWordPadding < l.top - a.yWordPadding || i.top - a.yWordPadding > l.bottom + a.yWordPadding))
				return !0;
		}
		return !1;
	}!(function e() {
		for (var n = 0; n < t.length; n += 1)
			for (
				var r = l(t[n].word, t[n].freq), i = 0; i < a.spiralLimit &&
				!d(i, function(e, t) {
					return c(r, s.x + e, s.y + t), !0;
				}); i++
			);
	})(),
	(function e() {
		if ((i.beginPath(), a.trace)) {
			...
			!(function e() {
				d(t, function(e, t) {
						var a, n;
						(a = s.x + e), (n = s.y + t), i.fillRect(a, n, 1, 1);
					}),
					(t += 1) < a.spiralLimit && window.requestAnimationFrame(e);
			})();
		}
	})();
}
...
function scroll_cb() {
	...
	$(window).scrollTop(),
		(e = $(window).scrollTop()),
		$("h2[id], ul[id], h3[id]").each(function(t, a) {
			var n = $(a).offset().top,
				r = $(this).outerHeight(!0);
			if (e > n - 50 && e < n + r) {
				var i = $(a).attr("id");
				$(".single-post-nav li a[href='#" + i + "']").length > 0 && ($(".single-post-nav li a.current").removeClass("current"), $(".single-post-nav li a[href='#" + i + "']").addClass("current"));
			}
		});
}
	...
	$(document).ready(function() {
		jQuery(".lms-faqs .card-header").length > 0 &&
			$(".lms-faqs .card-header").click(function() {
				$(this).toggleClass("active").next(".collapse").slideToggle().parent().siblings().find(".collapse").slideUp().prev().removeClass("active");
			}),
