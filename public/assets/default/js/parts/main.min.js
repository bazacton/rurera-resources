...
function rurera_modal_alert(msg_type, msg_title, confirmButton = true, html_template = '', afterConfirmFunc = '') {
    ...
    Swal.fire({
        ...
        cancelButtonText: 'Continue Working', // ✅ Change text of Cancel button
        showCloseButton: true,
    }).then((result) => {
        ...
        if (result.isDismissed) {
            // This happens when Cancel or Close button is clicked
            // You can optionally handle cancel here
        }
    });
...
$(document).ready(function () {
    ...
    // 🔒 Stop script if elements do not exist
