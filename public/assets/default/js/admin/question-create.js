...
$(document).on('change', 'select[name="rureraform-label_type"]', function () {
    ...
    $(this)
        ...
        .find('.summernote-editor') // this should be the textarea/div initialized with summernote
        .summernote('code', "Question Label");
    if(label_type == 'paragraph'){

        $(this)
            .closest('.rureraform-admin-popup.active')
            .find('.summernote-editor') // this should be the textarea/div initialized with summernote
            .summernote('code', "<p><b>Lorem Ipsum</b> is simply <u>dummy text</u> of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>\n" +
