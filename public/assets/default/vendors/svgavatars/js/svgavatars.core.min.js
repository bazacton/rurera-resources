	...
	'<div id="svga-container" class="svga-no-touch">',
		...
		'<div class="svga-row first-row">',
			'<div class="svga-col-left">',
				...
				'<div class="svga-row rurera-hide">',
					'<div id="svga-footermenu">',
						'<ul>',
							...
							'<li id="svga-saveavatar2"><div></div><span class="svga-mobilehidden">',translation.saveMsg,'</span></li>',
			...
			'<div class="svga-col-right">',
				...
				'<div class="svga-vert-order-main">',
					...
					'</div>',
				'</div>',
				'<div class="svga-row rurera-hide-sm">',
					'<div id="svga-footermenu">',
						'<ul>',
							'<li id="svga-randomavatar"><div></div><span class="svga-mobilehidden">',translation.randomMsg,'</span></li>',
							'<li id="svga-resetavatar"><div></div><span class="svga-mobilehidden">',translation.resetMsg,'</span></li>',
	...
	function svgAvatars(gender, jsonData) {
		...
		for (currentZone in jsonData) {
			if (jsonData.hasOwnProperty(currentZone)) {
                ...
                $('#svga-elements').append('<label id="svga-elements-' + currentZone + '-label" class="element-object-label">'+currentZone+'</label><div class="svga-elements-wrap" id="svga-elements-' + currentZone + '"></div>');
                ...
                $('#svga-elements-' + currentZone + '-label').hide();

				$('#svga-colors').append('<label id="svga-colors-' + currentZone + '-colors" class="element-colors-label">'+currentZone+' Colors</label><div id="svga-colors-' + currentZone + '" class="svga-colors-set face-colors---"></div>');
        ...
        $('#svga-saveavatar, #svga-saveavatar2').on('click', function() {
            $('#svga-work-overlay').fadeIn('fast');
            ...
            $.ajax({
                ...
                overlayMessage(token_id);
                //overlayMessage(translation.alertErrorCommon);
            });
        });

		$('#svga-saveavatar-token').on('click', function() {
			$('#svga-work-overlay').fadeIn('fast');
			...
			$.ajax({
				url: '/users/update_avatar_token',//saveUrl,
				type: 'post',
				dataType: 'text',
				headers: {
					'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
				...
				if (options.debug) { console.log('Avatar save done response: ', response); }
				$('#svga-message-text').html('Avatar Generated Successfully111!').removeClass('svga-error');
				$('#svga-work-overlay').fadeIn('fast');
				$('#svga-message').fadeIn('fast');
				//window.location.href = '/panel/setting';
			}).fail(function(response) {
