	...
	function svgAvatars(gender, jsonData) {
		...
		for (currentZone in jsonData) {
			if (jsonData.hasOwnProperty(currentZone)) {
				...
				$('#svga-colors').append('<label id="svga-colors-' + currentZone + '-colors">'+currentZone+' Colors</label><div id="svga-colors-' + currentZone + '" class="svga-colors-set face-colors---"></div>');
