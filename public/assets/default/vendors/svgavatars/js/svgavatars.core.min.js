	...
	function svgAvatars(gender, jsonData) {
		...
		for (currentZone in jsonData) {
			if (jsonData.hasOwnProperty(currentZone)) {
                ...
                $('#svga-elements').append('<label id="svga-colors-' + currentZone + '-label" class="element-object-label">'+currentZone+'</label><div class="svga-elements-wrap" id="svga-elements-' + currentZone + '"></div>');
                ...
                $('#svga-colors-' + currentZone + '-label').hide();
