(function ($) {
    ...
    if( $(".quiz-start-btn").length > 0){
        ...
        var no_of_questions = thisObj.data('no_of_questions');
		var is_new = thisObj.data('is_new');
		var journey_item_id = thisObj.data('journey_item_id');
        var is_pdf = thisObj.data('is_pdf');
        ...
        jQuery.ajax({
            ...
            data: {"is_pdf":is_pdf,"no_of_questions":no_of_questions,"learning_journey":learning_journey,"test_type":test_type,"question_ids":question_ids,"is_new":is_new, "journey_item_id" : journey_item_id},
            success: function (html) {
                quiz_loaded = true;
                if($(".practice-start-block").length > 0) {
                    $(".practice-start-block").attr('data-quiz_loaded', 'yes');
                }
        ...
        if( quiz_loaded == false){
            ...
            var quizLoadInterval = setInterval(function () {
                if( quiz_loaded == true){
                    ...
                    if($('.rurera-question-block.active').length > 0){
                    ...
                    if($('.rurera-question-block').length > 0) {
